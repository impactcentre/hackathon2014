...
(define (impactConvertEPStoPNG infile outfile interlace compression)
...
(script-fu-register
   "impactConvertEPStoPNG"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertEPStoPNG" 
   "impact Convert EPS to PNG"
   "IMPACT"
