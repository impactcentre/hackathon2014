...
(define (impactConvertPStoGIF infile outfile interlace dither palette num-colors alpha-dither remove-unused)
...
(script-fu-register
   "impactConvertPStoGIF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPStoGIF"
   "impact Convert PS to GIF" 
   "IMPACT"
