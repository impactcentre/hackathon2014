...
(define (impactConvertBMPtoPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertBMPtoPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertBMPtoPS" 
   "impact Convert BMP to PS"
   "IMPACT"
