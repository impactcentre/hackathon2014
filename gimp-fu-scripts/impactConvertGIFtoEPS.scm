...
(define (impactConvertGIFtoEPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertGIFtoEPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertGIFtoEPS" 
   "impact Convert GIF to EPS"
   "IMPACT"
