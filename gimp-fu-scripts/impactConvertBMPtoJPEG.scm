...
(define (impactConvertBMPtoJPEG infile outfile quality smoothing optimize progressive)
...
(script-fu-register
   "impactConvertBMPtoJPEG"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertBMPtoJPEG"
   "impact Convert BMP to JPEG" 
   "IMPACT"
