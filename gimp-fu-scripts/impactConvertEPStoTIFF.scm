...
(define (impactConvertEPStoTIFF infile outfile num-colors compression)
...
(script-fu-register
   "impactConvertEPStoTIFF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertEPStoTIFF" 
   "impact Convert EPS to TIFF"
   "IMPACT"
