...
(define (impactConvertEPStoGIF infile outfile interlace dither palette num-colors alpha-dither remove-unused)
...
(script-fu-register
   "impactConvertEPStoGIF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertEPStoGIF"
   "impact Convert EPS to GIF" 
   "IMPACT"
