...
(define (impactConvertTIFFtoPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertTIFFtoPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertTIFFtoPS" 
   "impact Convert TIFF to PS"
   "IMPACT"
