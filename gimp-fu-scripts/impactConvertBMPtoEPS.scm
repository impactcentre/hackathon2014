...
(define (impactConvertBMPtoEPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertBMPtoEPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertBMPtoEPS" 
   "impact Convert BMP to EPS"
   "IMPACT"
