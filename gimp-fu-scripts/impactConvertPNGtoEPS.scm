...
(define (impactConvertPNGtoEPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertPNGtoEPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPNGtoEPS" 
   "impact Convert PNG to EPS"
   "IMPACT"
