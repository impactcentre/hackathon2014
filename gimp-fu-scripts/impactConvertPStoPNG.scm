...
(define (impactConvertPStoPNG infile outfile interlace compression)
...
(script-fu-register
   "impactConvertPStoPNG"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPStoPNG" 
   "impact Convert PS to PNG"
   "IMPACT"
