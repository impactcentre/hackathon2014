...
(define (impactConvertPStoEPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertPStoEPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPStoEPS" 
   "impact Convert PS to EPS"
   "IMPACT"
