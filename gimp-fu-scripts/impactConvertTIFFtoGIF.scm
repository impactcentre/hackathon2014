...
(define (impactConvertTIFFtoGIF infile outfile interlace dither palette num-colors alpha-dither remove-unused)
...
(script-fu-register
   "impactConvertTIFFtoGIF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertTIFFtoGIF"
   "impact Convert TIFF to GIF" 
   "IMPACT"
