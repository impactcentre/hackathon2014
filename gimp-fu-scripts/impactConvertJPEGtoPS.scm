...
;   jpeg-flag     INT32     Default: 0, 0: PostScript, 1: Encapsulated PostScript
...
(define (impactConvertJPEGtoPS infile outfile width height x-offset y-offset unit 
	...
	(let* ((image (car (file-jpeg-load 1 infile infile)))
	 ...
	 (file-ps-save
		 ...
		 0            ;   jpeg-flag     INT32     0: PostScript, 1: Encapsulated PostScript | Difference PS/PS!!
...
(script-fu-register
   "impactConvertJPEGtoPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertJPEGtoPS" 
   "impact Convert JPEG to PS"
   "IMPACT"
