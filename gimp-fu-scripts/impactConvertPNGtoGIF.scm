...
(define (impactConvertPNGtoGIF infile outfile interlace dither palette num-colors alpha-dither remove-unused)
...
(script-fu-register
   "impactConvertPNGtoGIF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPNGtoGIF"
   "impact Convert PNG to GIF" 
   "IMPACT"
