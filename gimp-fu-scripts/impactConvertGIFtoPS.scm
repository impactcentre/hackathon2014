...
(define (impactConvertGIFtoPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertGIFtoPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertGIFtoPS" 
   "impact Convert GIF to PS"
   "IMPACT"
