...
(define (impactConvertBMPtoTIFF infile outfile num-colors compression)
...
(script-fu-register
   "impactConvertBMPtoTIFF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertBMPtoTIFF" 
   "impact Convert BMP to TIFF"
   "IMPACT"
