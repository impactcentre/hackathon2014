...
(define (impactConvertPNGtoTIFF infile outfile num-colors compression)
...
(script-fu-register
   "impactConvertPNGtoTIFF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPNGtoTIFF" 
   "impact Convert PNG to TIFF"
   "IMPACT"
