...
(define (impactConvertEPStoJPEG infile outfile quality smoothing optimize progressive)
...
(script-fu-register
   "impactConvertEPStoJPEG"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertEPStoJPEG"
   "impact Convert EPS to JPEG" 
   "IMPACT"
