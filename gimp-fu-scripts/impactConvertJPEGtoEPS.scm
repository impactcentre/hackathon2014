...
(define (impactConvertJPEGtoEPS infile outfile width height x-offset y-offset unit 
...
(script-fu-register
   "impactConvertJPEGtoEPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertJPEGtoEPS" 
   "impact Convert JPEG to EPS"
   "IMPACT"
