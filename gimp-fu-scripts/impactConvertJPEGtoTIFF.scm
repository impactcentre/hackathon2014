...
(define (impactConvertJPEGtoTIFF infile outfile num-colors compression)
...
(script-fu-register
   "impactConvertJPEGtoTIFF"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertJPEGtoTIFF" 
   "impact Convert JPEG to TIFF"
   "IMPACT"
