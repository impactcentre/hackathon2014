...
;   png-flag     INT32     Default: 0, 0: PostScript, 1: Encapsulated PostScript
...
(define (impactConvertPNGtoPS infile outfile width height x-offset y-offset unit 
	...
	(let* ((image (car (file-png-load 1 infile infile)))
	 ...
	 (file-ps-save
		 ...
		 0            ;   png-flag     INT32     0: PostScript, 1: Encapsulated PostScript | Difference PS/PS!!
...
(script-fu-register
   "impactConvertPNGtoPS"
   "<Toolbox>/Xtns/Script-Fu/impact/impactConvertPNGtoPS" 
   "impact Convert PNG to PS"
   "IMPACT"
